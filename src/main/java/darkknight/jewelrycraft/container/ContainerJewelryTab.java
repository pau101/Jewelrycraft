...
public class ContainerJewelryTab extends Container
{
    public ContainerJewelryTab(EntityPlayer player, InventoryPlayer inv)
    {
        ...
        for (x = 0; x <= 9; x++)
        {
            addSlotToContainer(new SlotRing(new JewelryInventory(), x, 8 + x * 18, 7));
        }
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        // if (par2 < 27)
        // {
        // if (!this.mergeItemStack(itemstack1, 27, this.inventorySlots.size(),
        // true)) { return null; }
        // }
        // else if (!this.mergeItemStack(itemstack1, 0, 27, false)) { return
        // null; }
        //
